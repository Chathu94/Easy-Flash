...
export default () => (
  <View style={styles.container}>
    <ScrollView contentContainerStyle={{ padding: 20 }}>
      ...
      <Text style={styles.p}>
        Hashan Chathuranga built the Simple Torch app as an Ad Supported
        app. This SERVICE is provided by Hashan Chathuranga at no cost and
      ...
      <Text style={styles.p}>
        ...
        our Terms and Conditions, which is accessible at Simple Torch unless
        otherwise defined in this Privacy Policy.
      </Text>
      <Text style={styles.b}>Information Collection and Use</Text>
      <Text style={styles.p}>
      ...
      <View>
        ...
        <View style={styles.ul}>
          <View style={styles.li}>
            ...
            <Text style={{ marginLeft: 5 }}>Google Play Services</Text>
          </View>
          <View style={styles.li}>
            <Ionicons name="ios-radio-button-on" size={10} />
            <Text style={{ marginLeft: 5 }}>AdMob</Text>
          </View>
        </View>
      </View>
      <Text style={styles.b}>Log Data</Text>
      <Text style={styles.p}>
      ...
      <Text style={styles.b}>Service Providers</Text>
      <Text style={styles.p}>
      ...
      <View style={styles.ul}>
        <View style={styles.li}>
          <Ionicons name="ios-radio-button-on" size={10} />
          <Text style={{ marginLeft: 5 }}>To facilitate our Service</Text>
        </View>
        <View style={styles.li}>
          <Ionicons name="ios-radio-button-on" size={10} />
          <Text style={{ marginLeft: 5 }}>To provide the Service on our behalf</Text>
        </View>
        <View style={styles.li}>
          <Ionicons name="ios-radio-button-on" size={10} />
          <Text style={{ marginLeft: 5 }}>To perform Service-related services</Text>
        </View>
        <View style={styles.li}>
          <Ionicons name="ios-radio-button-on" size={10} />
          <Text style={{ marginLeft: 5 }}>To assist us in analyzing how our Service is used</Text>
        </View>
      </View>
      <Text style={styles.p}>
      ...
      <Text style={styles.b}>Security</Text>
      <Text style={styles.p}>
      ...
      <Text style={styles.b}>Links to Other Sites</Text>
      <Text style={styles.p}>
      ...
      <Text style={styles.b}>Children’s Privacy</Text>
      <Text style={styles.p}>
      ...
      <Text style={styles.b}>Changes to This Privacy Policy</Text>
      <Text style={styles.p}>
      ...
      <Text style={styles.b}>Contact Us</Text>
      <Text style={styles.p}>
